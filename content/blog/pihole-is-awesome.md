...
{% image src="pihole-before.png" alt="Site before pihole" /%}

Aaaaaaand they're gone.

{% image src="pihole-after.png" alt="Site after pihole" /%}
...
{% image src="pihole-panel.png" alt="Pihole panel" /%}
...
{% image src="pihole-dns-setup.png" alt="pihole dns setup" /%}
...
{% image src="pihole-test.png" alt="pihole-test" /%}
