...
{% image src="terraform-plan.png" alt="Terraform Plan" /%}

Terraform Explore without a search parameter, notice how the state shows up in the previewer
{% image src="terraform-explore.png" alt="Terraform Plan" /%}
...
{% image src="terraform-explore-pick.png" alt="Terraform Plan" /%}
